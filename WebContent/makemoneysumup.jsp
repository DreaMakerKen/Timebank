...
<body>
	...
	vBlockchainTest.money_sum_up(towhichpeer);
	...
	<div class="container">
		...
		<br> <p class="fontCh">給節點:<%=towhichpeer%></p>
		<br> <p class="fontCh">多少錢:<%=vBlockchainTest.getPrice(towhichpeer)%></p>
	</div>
