...
<form action="hello2.jsp" method="post">
  <h1><p class="font">Transcation</p></h1><br>
...
<input type = "button" value = "觀看現有區塊資料" onclick = "window.location.href = 'printchain.jsp'">
<input type = "button" value = "查詢餘額" onclick = "window.location.href = 'balance.jsp'">
</body>
</html>